...
var remoteVersions = map[int]string{
	...
	3: "https://raw.githubusercontent.com/MrXiaoM/qsign/mirai/txlib/8.9.73/android_pad.json",
	5: "https://raw.githubusercontent.com/rhwong/unidbg-fetch-qsign-onekey/1.1.9-fix2/txlib/8.9.80/android_pad.json",
}
